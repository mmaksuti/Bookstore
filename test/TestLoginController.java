...
//    @Test
//    void test_removeUserNoBooks() {
//        String firstName = "John";
//        String lastName = "Doe";
//        Gender gender = Gender.MALE;
//
//        try {
//            loginController.addUser(firstName, lastName, gender);
//        } catch (IOException ex) {
//            fail("Failed to add user: " + ex.getMessage());
//        }
//
//        when(booksController.getBooks()).thenReturn(books);
//
//        User user = loginController.getUsers().get(0);
//        try {
//            loginController.removeUser(booksController, user, null);
//        }
//        catch (IOException ex) {
//            fail("Failed to remove user: " + ex.getMessage());
//        }
...
//
//    @Test
//    void test_removeUserWithBooksConfirmIsFalse() {
//        String firstName = "John";
//        String lastName = "Doe";
//        Gender gender = Gender.MALE;
//
...
//        User user = loginController.getUsers().get(0);
//
//        Book testBook = new Book("", "", "", 1.0, user, new ArrayList<>(), 1, true);
//        books.add(testBook);
//        when(booksController.getBooks()).thenReturn(books);
//
...
//
//        try {
//            loginController.removeUser(booksController, user, mockedConfirmation);
//        }
//        catch (IOException ex) {
//            fail("Failed to remove user: " + ex.getMessage());
//        }
...
//
//    @Test
//    void test_removeUserWithBooksConfirmIsTrue() {
//        String firstName = "John";
//        String lastName = "Doe";
//        Gender gender = Gender.MALE;
//
